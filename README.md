...
## Introduction
Dear Netradyne Team, after some research about Netradyne's product suite, I have decided to apply my system design skills to solve a specific problem that I figured you might have encountered (and potentially solved). The purpose of this architecture doc is to help you understand how I think about system architecture when given a problem statement.
